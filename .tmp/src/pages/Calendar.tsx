                            ...
                            <div className="space-y-4">
                                ...
                                {selectedDayData.cardioMinutes > 0 && (
                                    <div className="bg-black p-4 rounded-lg">
                                        ...
                                        <p className="text-2xl text-white font-bold">
                                            {selectedDayData.cardioMinutes} / {DAILY_CARDIO_TARGET_MIN} <span className="text-lg">דקות</span>
                                        </p>
                                        <p className="text-xs text-muted-foreground mt-1">
                                            {DAILY_CARDIO_TARGET_MIN} דקות זה היעד היומי שלך
                                        </p>
                                        {selectedDayData.cardioMinutes >= DAILY_CARDIO_TARGET_MIN && (
                                ...
                                {selectedDayData.sleepHours > 0 && (
                                    <div className="bg-black p-4 rounded-lg">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            יעד: {SLEEP_TARGET_MIN}–{SLEEP_TARGET_MAX} שעות בלילה
                                        </p>
                                        {selectedDayData.sleepHours >= SLEEP_TARGET_MIN && selectedDayData.sleepHours <= SLEEP_TARGET_MAX && (
                                            <p className="text-xs text-green-400 mt-1">✓ יעד יומי הושג</p>
                                        )}
                                    </div>
                                )}
