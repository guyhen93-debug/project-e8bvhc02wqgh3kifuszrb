...
const WorkoutA = () => {
    ...
    const { data: lastWorkoutData } = useQuery({
        queryKey: ['last-workout-log', 'A'],
        queryFn: async () => {
            const logs = await WorkoutLog.filter({ 
                workout_type: 'A' 
            }, '-date', 1);
            console.log('Loaded last workout A:', logs);
            return logs[0] || null;
        },
        staleTime: 60000,
    });
        ...
        <div className="min-h-screen bg-oxygym-dark pb-20">
            <div className="container mx-auto px-4 py-8 max-w-3xl">
                ...
                <div className="mb-6 p-4 bg-oxygym-darkGrey rounded-lg">
                    <img 
                        src="https://ellprnxjjzatijdxcogk.supabase.co/storage/v1/object/public/superdev-project-images/9d9da483-282b-4e6c-8640-d115b3edcbaf/e8bvhc02wqgh3kifuszrb/1764848183433-A.jpeg" 
                        alt="Leg Press Workout - אימון לחיצת רגליים" 
